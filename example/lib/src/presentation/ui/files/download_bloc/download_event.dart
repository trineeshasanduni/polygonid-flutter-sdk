...
class onClickDownload extends DownloadEvent {
  ...
  const onClickDownload(
      {required this.batch_hash, required this.file_hash, required this.didU,required this.fileHash});
}
...
class onClickDownloadUrl extends DownloadEvent {
  ...
  const onClickDownloadUrl(
      {required this.BatchHash, required this.FileHash,required this.fileHash, required this.Odid, required this.FileName, required this.Cids});
}
...
final class onGetDownloadStatusEvent extends DownloadEvent {
  ...
  const onGetDownloadStatusEvent(this.sessionId, this.batch_hash, this.fileHash);
}
...
class GetCidsEvent extends DownloadEvent {
  ...
  const GetCidsEvent( {required this.index,required this.did, required this.owner, required this.batch_hash,required this.fileHash});
}
