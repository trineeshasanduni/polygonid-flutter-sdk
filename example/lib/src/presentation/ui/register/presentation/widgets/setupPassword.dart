              ...
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    onTap: () async {
                      print('fetch longin details');
                      try {
                      // BlocBuilder<LoginsBloc, LoginsState>(
                      //   builder: (context, state) {
                      //     if (state is LoginLoaded) {
                      //       return LoginQr(response: state.loginResponse.loginDetails,header: state.loginResponse.headers,);
